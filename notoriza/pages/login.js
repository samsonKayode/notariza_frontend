    ...
    return (
        <div className="loginPage">
            ...
            <div className="loginSection">
                ...
                <span className="alternate">OR LOGIN WITH EMAIL</span>
                <form onSubmit={handleSubmit} className="loginForm">
                    ...
                    <div className="loginRegister">Don’t have an account? <Link href="/register"><a className="register" className="registerLink">Register</a></Link> </div>
                </form>
            </div>
